...
//  2025-03-10: Map GLFW_KEY_WORLD_1 and GLFW_KEY_WORLD_2 into a reasonable ImGui key.
...
ImGuiKey ImGui_ImplGlfw_KeyToImGuiKey(int keycode, int scancode)
{
    ...
    switch (keycode)
    {
        ...
        // ImGui removed ImGuiKey_Oem102 in newer versions. WORLD_1/2 are non-US keys; map them to GraveAccent.
        case GLFW_KEY_WORLD_1: return ImGuiKey_GraveAccent;
        case GLFW_KEY_WORLD_2: return ImGuiKey_GraveAccent;
